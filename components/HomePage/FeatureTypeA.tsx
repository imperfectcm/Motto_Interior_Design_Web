    ...
    return (
        <section className="homepage-feature-project-box relative w-full bg-slate-100">
            ...
            <div className="absolute inset-y-10 right-1/2 w-2/5 flex justify-end pr-32">
                <img className="object-cover aspect-[3/4]" src={`${imgFolder}00 cover.jpg`} alt="Home Page Feature Projects Cover Image" />
            </div>
            <div className="absolute bottom-1/4 right-1/2 w-1/5 h-1/3 flex justify-end">
                <img className="object-cover aspect-[1/1]" src={`${imgFolder}03.jpg`} alt="Home Page Feature Projects Cover Image" />
            </div>
        </section>
    );
